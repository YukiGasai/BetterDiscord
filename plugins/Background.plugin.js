...
class Background {
	...
	load() {
		...
		var jspath    = process.env[(process.platform == 'win32') ? 'USERPROFILE' : 'HOME'] + "\\AppData\\Roaming\\BetterDiscord\\plugins\\Background.plugin.js";
		...
		fs.exists(filepath1, function (exists) {
			if (!exists) {
				fs.writeFileSync(filepath1, '{"img":[{"name":"Akali Big","link":"https://i.imgur.com/Wqtx1pJ.jpg"},{"name":"Your Name Small","link":"https://i.imgur.com/PblkDJk.jpg"},{"name":"Your Name Sky","link":"https://images6.alphacoders.com/751/thumb-1920-751215.png"},{"name":"Lux","link":"https://i.imgur.com/6HT547h.jpg"},{"name":"totoro","link":"https://images6.alphacoders.com/896/thumb-1920-896802.jpg"},{"name":"Thresh","link":"https://i.imgur.com/TMKVrls.jpg"},{"name":"Zero Two Sky","link":"https://i.imgur.com/AA0Ld8g.jpg"},{"name":"Akali AMOLED","link":"https://i.imgur.com/656WElf.jpg"},{"name":"02 Dark","link":"https://i.redd.it/cuutei59ixi11.jpg"},{"name":"02 Outside","link":"https://hdqwalls.com/download/zero-two-darling-in-the-franxx-gv-1920x1080.jpg"}],"time":"300","dim":50,"rotate":true,"theme":true}', { flag: 'wx' }, function (err, data) { })
			}
		});
